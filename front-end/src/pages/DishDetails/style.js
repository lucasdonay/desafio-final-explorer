    ...
    main {
      ...
      > div {
        ...
        .details {
          ...
          h2 {
            font-weight: ${({ theme }) =>
              theme.fonts.poppins.medium_500.weight};
            font-size: ${({ theme }) => theme.fonts.poppins.medium_500.size};
            line-height: ${({ theme }) =>
              theme.fonts.poppins.medium_500.height};
          }

          p {
            font-weight: ${({ theme }) =>
              theme.fonts.poppins.regular_300.weight};
            font-size: ${({ theme }) => theme.fonts.poppins.regular_300.size};
            line-height: ${({ theme }) =>
              theme.fonts.poppins.regular_300.height};
          }
